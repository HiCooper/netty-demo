 ...
 *
 */
package com.berry.netty.commons.constant;
...
public class CommonConstant {
     ...
     * 全局字典信息
     */
    private static Map<String, Map<String, String>> commonParamsMap = new HashMap<>();

    private static Map<String, Map<String, String>> commonParamsObject = new HashMap<>();
     ...
     * @param map
     */
    public static void updateCommonParamsObject(Map<String, Map<String, String>> map) {
        commonParamsObject.putAll(map);
    }
     ...
     * @return
     */
    public static String getObjectDesc(String parentName, String childvalue, Long unitid) {
        if (commonParamsObject.containsKey(parentName)) {

            if (childvalue != null && unitid != null) {
                return commonParamsObject.get(parentName).get(childvalue + unitid);
            } else {
                return childvalue;
            }
        } else {
    ...
    public enum UploadStatus {
        ...
        public static String getDescByValue(String value) {
            ...
            } else if (UploadedFail.value.equals(value)) {
    ...
    public enum BranchState {
        ...
        BranchState(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum GoodStatus {
        ...
        GoodStatus(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum IsTestCard {
        ...
        IsTestCard(int value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum PhscType {
        ...
        PhscType(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum CardFlag {
        ...
        CardFlag(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum CommState {
        ...
        CommState(String value, String desc) {
    ...
    public enum TmkDownFlag {
        ...
        TmkDownFlag(String value, String desc) {
    ...
    public enum KeyaDownFlag {
        ...
        KeyaDownFlag(String value, String desc) {
    ...
    public enum IsUsed {
        ...
        IsUsed(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum RecordStat {
        ...
        RecordStat(String value, String desc) {
    ...
    public enum UserDataStatus {
        ...
        UserDataStatus(String value, String desc) {
    ...
    public enum DeductionType {
        ...
        DeductionType(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum PeriodType {
        ...
        PeriodType(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum RespsDesc {
        ...
        RespsDesc(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public static final String SIGN_IN = "1001";
    public static final String PARAMS_DOWNLOAD = "1002";
    public static final String DATA_UPLOAD = "1003";
    public static final String BUS_PARAMS_DOWNLOAD = "2001";
    public static final String BUS_CHARGE = "2002";
    public static final String ISSUE_CATD = "2003";
    public static final String BUS_KMS_DOWNLOAD = "2004";
    public static final String BUS_CHARGE_NOTICE = "2005";
    public static final String PBOC_ISSUE_CARD = "2006";
    public static final String CAMP_SIGN_IN = "3001";
    public static final String PARAMS_DOWNLOAD_CAMP = "3002";
    public static final String CAMP_DATA_UPLOAD = "3003";
    public static final String CAMP_PARAMS_DOWNLOAD = "4001";
    public static final String CAMP_ISSUE_CATD = "4003";
    public static final String CAMP_CHARGE = "4007";
    public static final String CAMP_CHARGE_NOTICE = "3008";
    public static final String CAMP_KMS_DOWNLOAD = "4002";
    public static final String CAMP_PBOC_ISSUE_CATD = "4004";
    public static final String CAMP_STORAGE = "4006";
    public static final String CAMP_PBOC_CHARGE = "4005";
    public static final String PC_DATA_UPLOAD = "6001";
    public static final String PC_POS_OFF = "6002";
    ...
    public enum MsgType {
        ...
        public static String getDescByValue(String value) {
            ...
            } else if (pcPosOff.value.equals(value)) {
                return pcPosOff.desc;
            } else {
                return null;
            }
        }
    ...
    public enum paraType {
        ...
        public static String getDescByValue(String value) {
            ...
            } else if (fileQuery.value.equals(value)) {
                return fileQuery.desc;
            } else if (fileDown.value.equals(value)) {
                return fileDown.desc;
            } else {
                return null;
            }
        }
    ...
    public enum MsgResp {
        ...
        CrdKindError("45", "卡类型错误"),
        LineCodeNotFound("50", "线路号不存在"),
        PriceNotFound("51", "票价不存在"),
        StationNotFound("52", "站点不存在"),
        PosFileNotFount("53", "清算文件不存在"),
        CardNotSupRefund("54", "该卡片不支持退卡"),
        blackExsit("55", "黑名单已存在"),
        SaleFail("56", "扣款失败"),;

        String value;
        String desc;

        MsgResp(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
        ...
        public static String getDescByValue(String value) {
            ...
            } else if (DataClearing.value.equals(value)) {
                return DataClearing.desc;
            } else if (CrdKindError.value.equals(value)) {
                return CrdKindError.desc;
            } else if (PosFileNotFount.value.equals(value)) {
                return PosFileNotFount.desc;
            } else if (CardNotSupRefund.value.equals(value)) {
                return CardNotSupRefund.desc;
            } else if (blackExsit.value.equals(value)) {
                return blackExsit.desc;
            } else if (SaleFail.value.equals(value)) {
                return SaleFail.desc;
            } else {
                return null;
            }
        }
    ...
    public enum KmsType {
        ...
        M1KeyA("1003", "M1KeyA下载"), M1KeyB("1004", "M1KeyB下载"), M1Tac("1005", "M1Tac校验"), M1TacKey("1006", "M1Tac密钥下载"), TreeDes("1007", "3Desc加密");
    ...
    public enum BusParaDown {
        ...
        BusParaDown(String value, String desc) {
    ...
    public enum CampParaDown {
        ...
        CampParaDown(String value, String desc) {
    ...
    public enum CampTxnType {
        ...
        CampTxnType(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum AuditFlag {
        ...
        AuditFlag(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum AutoStatus {
        ...
        AutoStatus(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum AccountType {
        ...
        AccountType(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum BatchStatus {
        ...
        BatchStatus(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
    ...
    public enum MsgEnc {
        ...
        MsgEnc(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
     ...
     * 报文解析版本号
     */
    public static final String POS = "F01";
    public static final String PC = "F11";
    public static final String QRCODD = "F21";
    ...
    public enum MsgVersion {
        POS("F01", "POS端发起交易"), PC("F11", "PC端上传交易"), QRDEMO("F21", "二维码演示");

        String value;
        String desc;

        MsgVersion(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
        ...
        public static String getDescByValue(String value) {
            if (POS.value.equals(value)) {
                ...
                return PC.desc;
            } else if (QRDEMO.value.equals(value)) {
                return QRDEMO.desc;
            } else {
                return null;
            }
     ...
     * 清次状态
     */
    public enum ClearTimeStat {

        NotClear("0", "(刷次)不清次"),
        MonthClear("1", "(刷次)月清次"),
        YearClear("2", "(刷次)年清次"),
        AmountNotClear("3", "(虚拟账户)不清次"),
        PbocNotClear("4", "(电子现金)不清次");

        String value;
        String desc;

        private ClearTimeStat(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
        ...
        public static String getDescByValue(String value) {
            if (NotClear.value.equals(value)) {
                return NotClear.desc;
            } else if (MonthClear.value.equals(value)) {
                return MonthClear.desc;
            } else if (YearClear.value.equals(value)) {
                return YearClear.desc;
            } else if (AmountNotClear.value.equals(value)) {
                return AmountNotClear.desc;
            } else if (PbocNotClear.value.equals(value)) {
                return PbocNotClear.desc;
            } else {
                return null;
            }
        }
    ...
    public enum CardType {
        ...
        UseCard("01", "发卡"), RefundCard("02", "退卡");
        ...
        public static String getDescByValue(String value) {
            if (UseCard.value.equals(value)) {
                return UseCard.desc;
            } else if (RefundCard.value.equals(value)) {
                return RefundCard.desc;
            } else {
                return null;
            }
        }
     ...
     * @author tanhw
     */
    public enum ResetStat {

        UseCard("0", "发卡"), Reset("1", "重置");

        String value;
        String desc;

        private ResetStat(String value, String desc) {
            this.value = value;
            this.desc = desc;
        }
